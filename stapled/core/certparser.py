...
:class:`stapled.core.taskcontext.StapleTaskContext` is created for the
:class:`stapled.core.oscprenewe.StapleRenewer` which is then scheduled to be
processed ASAP.
"""
...
class CertParserThread(threading.Thread):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :kwarg stapled.scheduling.SchedulerThread scheduler: The scheduler
            object where we can get parser tasks from and add renew tasks to.
            **(required)**.
